...
import { staticGroup } from '../../../../../resources/static';
  ...
  timelineTriggers: [
    {
      ...
      beforeSeconds: 3,
      condition: Conditions.isEnabled(staticGroup, 'P1S', 'P1S Tile Positions'),
  ...
  triggers: [
    {
      ...
      condition: Conditions.isEnabled(staticGroup, 'P1S', 'P1S Warder\'s Wrath'),
    ...
    },
    {
      ...
      condition: Conditions.isEnabled(staticGroup, 'P1S', 'P1S Shackles of Companionship'),
    ...
    },
    {
      ...
      condition: Conditions.isEnabled(staticGroup, 'P1S', 'P1S Shackles of Loneliness'),
    ...
    },
    {
      ...
      condition: Conditions.isEnabled(staticGroup, 'P1S', 'P1S Shining Cells'),
      response: Responses.aoe(),
    },
    {
      id: 'P1S Slam Shut',
      ...
      condition: Conditions.isEnabled(staticGroup, 'P1S', 'P1S Slam Shut'),
      response: Responses.aoe(),
    },
    {
      ...
      condition: Conditions.isEnabled(staticGroup, 'P1S', 'P1S Gaoler\'s Flail'),
    ...
    },
    {
      ...
      condition: Conditions.isEnabled(staticGroup, 'P1S', 'P1S Pitiless Flail'),
    ...
    },
    {
      ...
      condition: Conditions.isEnabled(staticGroup, 'P1S', 'P1S Intemperate Torment Direction'),
    ...
    // Copy/paste from normal, seems to be the same
    {
      ...
      condition: Conditions.targetIsYou() && Conditions.isEnabled(staticGroup, 'P1S', 'P1S Hot/Cold Spell'),
    ...
    },
    {
      ...
      condition: Conditions.isEnabled(staticGroup, 'P1S', 'P1S Powerful Light/Fire'),
      preRun: (data, matches) => {
    ...
    },
    {
      ...
      condition: Conditions.isEnabled(staticGroup, 'P1S', 'P1S Shackles of Time'),
      alertText: (data, matches, output) => {
    ...
    },
    {
      ...
      condition: Conditions.targetIsYou() && Conditions.isEnabled(staticGroup, 'P1S', 'P1S Fourfold Shackles'),
